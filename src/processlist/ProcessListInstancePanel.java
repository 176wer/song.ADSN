            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (ris == JOptionPane.YES_OPTION) {
                    ...
                    for (int i = 0; i < rowNum; i++) {
                        if (tableModel.getValueAt(i, 1).toString().equals(user))
                            pids.add(Long.parseLong(tableModel.getValueAt(i, 0).toString()));
                    }
