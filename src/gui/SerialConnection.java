...
//    private NodeLog nodeLog = new NodeLog();
    ...
    public void run() {
        while (true) {
            ...
            LiuLiang liu=frame.getLiuliang();
            System.out.println("liu  "+liulia);
            System.out.println("PublicContent.getfreshtime() "+PublicContent.getfreshtime());
            System.out.println(liulia/(PublicContent.getfreshtime()/1000));
            liu.addData(liulia/(PublicContent.getfreshtime()/1000));
