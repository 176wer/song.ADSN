/**
 * Project Name:ADSN
 * File Name:ytrewq.java
 * Package Name:jfreechart
 * Date:2016年1月4日上午10:15:40
    ...
    {   
                ...
                {   
                    ...
                    {   
                        ...
                        {   
                            ...
                            model.setValueAt(new Double(chartPanel.getChart().getXYPlot().getDomainAxis().getRange().getLowerBound()), i, 3);   
                        }   
                        if(ai[1] >= 0)   
                        {   
                        ...
                        {   
                            ...
                            model.setValueAt(new Double(chartPanel.getChart().getXYPlot().getDomainAxis().getRange().getUpperBound()), i, 5);   
                        }   
                        double d3 = 0.0D;   
                        if(l2 - l1 > 0L)   
        ...
        {   
            ...
            {   
                ...
                if(i == 0)   
                {   
                    jfreechart.getXYPlot().setDataset(axydataset[i]);   
                } else   
                {   
                    XYPlot xyplot1 = jfreechart.getXYPlot();   
                    xyplot1.setDataset(i, axydataset[i]);   
                    xyplot1.setRangeAxis(i, new NumberAxis("Axis " + (i + 1)));   
                    xyplot1.mapDatasetToRangeAxis(i, i);   
                    xyplot1.setRenderer(i, new XYLineAndShapeRenderer(true, false));   
                }   
            }   
        ...
        {   
            ...
            for(int i = 0; i < 4; i++)   
            {   
                model.setValueAt(jfreechart.getXYPlot().getDataset(i).getSeriesKey(0), i, 0);   
